...
# However, the function sometimes works correctly, but other times it produces incorrect results. Can you help your colleague fix the bug?
...
def find_maximum(numbers):
    ...
    for number in numbers:
        if number > max_number:
            ...
            # print(f'before max: {max_number}')
            max_number = number
            # print(f'after: {number}')
            # print(f'after max: {max_number}')
